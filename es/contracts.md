...
Las [facades](/docs/{{version}}/facades) de Laravel y los *helper* son una forma sencilla de utilizar los servicios de Laravel sin tener que hacer *type-hint* y resolver contratos fuera del *service container*. In most cases, each facade has an equivalent contract.
