...
> {tip} If you need an older version of PHP check the documentation on [multiple PHP versions](#multiple-php-versions) before attempting to use an old version of Homestead.
