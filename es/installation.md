...
Asegúrese de agregar la carpeta `$HOME/.composer/vendor/bin` (o el directorio equivalente para su sistema operativo) en su $PATH, así el ejecutable de `Laravel` podrá ser encontrado por su sistema.
